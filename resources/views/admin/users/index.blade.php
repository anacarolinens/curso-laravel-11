            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <a href="{{ route('users.create') }}"
                        class="mt-5 bg-blue-700 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition-all duration-300"
                    ...
                    <form action="{{ route('users.index') }}" method="GET" class="flex items-center px-4 py-1 rounded-md border-2 overflow-hidden max-w-md mx-auto mt-5 bg-white dark:bg-gray-700">
                        <input
                            type="text"
                            name="search"
